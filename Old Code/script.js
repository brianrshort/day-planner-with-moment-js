...
$(document).ready(function() {
  ...
  for (let timeOfDay = 8; timeOfDay <= 18; timeOfDay++) {
    ...
    let $colDiv1 = $('<div>');
    $colDiv1.addClass("col-4");
    $colDiv1.text(displayHour);

    let $colDiv2 = $('<textarea>');
    $colDiv2.addClass("col-4");
    $colDiv2.attr("rows" , 4);
    $colDiv2.attr("cols" , 40);


    let $colDiv3 = $('<button>');
    $colDiv3.addClass("col-4" , "input-button");
    let saveIcon = '<i class="far fa-save"></i>';
  ...
  //     $("planner-container").append($rowDiv);
...
//if little h === row value
  //then background color is red
//else if h < row value
  //then background color is light green
//else if h > row value
  //then background color is normal
